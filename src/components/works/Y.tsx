      ...
      <div className="container">
        <div style={{ marginTop: "40px" }}>
          ...
          <div className="div-pleft">
            <p>
              <span>Y?</span> is a personal project that took inspiration from
              the social media app that we know named X. This project is mostly
              an attempt to reproduce X's basic features and aims to give users
              at the very least a bare bones feel of a social media app via my
              ...
              different libraries, frameworks, and ideas - one example is the
              use of custom web components in typescript which helped me build
              this app's rich text input and some other components.
            </p>
            <br />
